         ...
         <div class="table-responsive-md">
            <table class="table table-hover">
               ...
               <tbody>
                  ...
                  <?php $counter = 1;
                  foreach ($sensorsData as $sensorName=>$sensorData) : ?>
                     <tr>
                        <th scope="row"><?php echo ($counter++) ?></th>
                        <td><?php print_r ($sensorName)?></td>
                        <td><?php print_r ($sensorData['occupancy'])?></td>
                        <td><?php print_r ($sensorData['temperature'])?></td>
                        <td><?php print htmlen ($sensorData['humidity'])?></td>
                     </tr>
                  <?php endforeach ?>
