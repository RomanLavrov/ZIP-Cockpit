...
/* harmony import */ var _Forge_Detectors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Forge/Detectors.js */ "./resources/js/Forge/Detectors.js");
/* harmony import */ var _Forge_Occupancy_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Forge/Occupancy.js */ "./resources/js/Forge/Occupancy.js");
/* harmony import */ var _Forge_Views_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Forge/Views.js */ "./resources/js/Forge/Views.js");
/* harmony import */ var _Forge_Sensors_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Forge/Sensors.js */ "./resources/js/Forge/Sensors.js");
...
AttributeExtension.prototype.load = function () {
  ...
  viewer = this.viewer; //this.onSelectionBinded = this.onSelectionEvent.bind(this);
  //this.viewer.addEventListener(Autodesk.Viewing.SELECTION_CHANGED_EVENT, this.onSelectionBinded);

  this.onSelectionBinded = null; // var ext = this;
  ...
  viewer.addEventListener(Autodesk.Viewing.OBJECT_TREE_CREATED_EVENT, function () {
    ...
    tree.enumNodeChildren(rootId, function (childId) {
      var childName = tree.getNodeName(childId); //detectors.push(childName);
...
function Toolbar(viewer) {
  ...
  buttonDetectors.onClick = function () {
    Object(_Forge_Sensors_js__WEBPACK_IMPORTED_MODULE_3__["ShowSensors"])(viewer, viewer.container);
  };
  ...
  buttonOccupancy.onClick = function () {
    Object(_Forge_Occupancy_js__WEBPACK_IMPORTED_MODULE_1__["ShowOccupancy"])(viewer, viewer.container);
  };
  ...
  buttonViews.onClick = function () {
    Object(_Forge_Views_js__WEBPACK_IMPORTED_MODULE_2__["ShowViews"])(viewer, viewer.container);
  };
...
/*!*****************************************!*\
  !*** ./resources/js/Forge/Detectors.js ***!
  \*****************************************/
/*! exports provided: ShowDetectors */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShowDetectors", function() { return ShowDetectors; });
console.log('Detectors script loaded');
var detectors = [];
var detectorNameToSearch = 'E_UKV';

function ShowDetectors(viewer, container) {
  console.log("Show Detectors");

  if (window.panelDetectors === undefined) {
    window.panelDetectors = new DetectorsPanel(viewer, viewer.container, 'detectorsPanel', 'Detectors');
  } // show/hide docking panel


  window.panelDetectors.setVisible(!window.panelDetectors.isVisible());
}
...
function DetectorsPanel(viewer, container, id, title, options) {
  ...
  getDetectors(viewer);
  this.viewer = viewer; // the style of the docking panel
  ...
  this.container.dockBottom = true; // this is where we should place the content of our panel
  ...
  var panel = document.createElement('div'); //panel.className = ('panel panel-default');
  ...
  detectors.forEach(function (element) {
...
function getDetectors(viewer) {
  ...
  allDBId.forEach(function (id) {
    if (tree.getNodeName(id).includes(detectorNameToSearch) && tree.getNodeName(id).includes('[', ']')) {
      ...
      viewer.model.getProperties(id, function (result) {//console.log(result.properties);
      });
...
function initializeMarkup(detectors) {
  ...
  window.addEventListener("onMarkupMove", function (e) {
    moveLabel(e.detail);
  }, false);
  window.addEventListener("onMarkupClick", function (e) {
    elem.innerHTML = "";
...
/*!*****************************************!*\
  !*** ./resources/js/Forge/Occupancy.js ***!
  \*****************************************/
/*! exports provided: ShowOccupancy */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShowOccupancy", function() { return ShowOccupancy; });
...
function ShowOccupancy() {
  ...
  if (window.panelOccupancy == undefined) {
    window.panelOccupancy = new OccupancyPanel(viewer, viewer.container, 'occupancyPanel', 'Occupancy');
  }

  window.panelOccupancy.setVisible(!window.panelOccupancy.isVisible()); //viewer.select([rooms[0]['id']]);
...
function getRooms(viewer) {
  ...
  listViewElements.forEach(function (id) {
...
function changeRoomColor(room) {
  var color = 0x00ff00;
  var material = addMaterial(color); //viewer.impl.setSelectionColor(new THREE.Color(0,1,0))
...
function renderRoomShader() {
  console.log('room number in this specific floor:' + rooms.length);
  var colorIndex = 0;
  $.each(rooms, function (num, room) {
    console.log('room dbid:' + room['id']);
    if (colorIndex > 5) colorIndex = 0;
    var faceMeshArray = [];
    var instanceTree = viewer.model.getData().instanceTree;
    instanceTree.enumNodeFragments(room['id'], function (fragId) {
      var renderProxy = viewer.impl.getRenderProxy(viewer.model, fragId);
      ...
      for (var oi = 0, ol = offsets.length; oi < ol; ++oi) {
        ...
        for (var i = start, il = start + count; i < il; i += 3) {
          ...
          for (var f = 0; f < faces.length; f++) {
            var faceMesh = drawFaceMesh(faceGeometry, _overlaySceneName, _materialArray[colorIndex], renderProxy);
...
function CreateMeshMaterials() {
  console.log("Create Mesh Material"); //create a default face material 

  _defaultFaceMaterial = createFaceMaterial("#b4ff77", 0.9, true); //hex color array for different rooms
  ...
  viewer.impl.createOverlayScene(_overlaySceneName); //getRooms(); 
...
function createFaceMaterial(colorhex, opacity, transparent) {
  ...
  viewer.impl.matman().addMaterial(_customMaterialPrefix + newGUID(), material, true);
  return material;
}
...
/***/ "./resources/js/Forge/Sensors.js":
/*!***************************************!*\
  !*** ./resources/js/Forge/Sensors.js ***!
  \***************************************/
/*! exports provided: ShowSensors */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function ShowSensors() {
  ...
  if (window.panelSensors == undefined) {
    window.panelSensors = new SensorsPanel(viewer, viewer.container, 'sensorsPanel', 'Sensors');
  }
...
function getDetectors(viewer) {
  ...
  allDBId.forEach(function (id) {
    if (tree.getNodeName(id).includes(detectorNameToSearch)
    /*&& tree.getNodeName(id).includes('[', ']')*/
    ) {
        var fragIds = [];
        var fragList = viewer.model.getFragmentList();
        tree.enumNodeFragments(id, function (fragId) {
...
/***/ "./resources/js/Forge/Views.js":
/*!*************************************!*\
  !*** ./resources/js/Forge/Views.js ***!
  \*************************************/
/*! exports provided: ShowViews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShowViews", function() { return ShowViews; });
...
function getViews() {
  ...
  xmlHttpViews.setRequestHeader("Authorization", "Bearer " + window.token, "x-ads-force: true");
  xmlHttpViews.send();
...
function loadView(viewer, index) {
  viewer.tearDown();
  viewer.start();
  var geometries = window.viewerDocument.getRoot().search({
    'type': 'geometry'
  });
  var path = window.viewerDocument.getViewablePath(geometries[index]);
...
// MarkupExt.js
console.log('Markup Extension started');
var viewer;

function markup3d(_viewer, options) {
  viewer = _viewer;
  Autodesk.Viewing.Extension.call(this, viewer, options);
  this.raycaster = new THREE.Raycaster();
  this.raycaster.params.PointCloud.threshold = 5; // hit-test markup size.  Change this if markup 'hover' doesn't work

  this.size = 100.0; // markup size.  Change this if markup size is too big or small

  this.lineColor = 0x744FC6; // off-white

  this.labelOffset = new THREE.Vector3(80, 80, 80); // label offset 3D line offset position

  this.xDivOffset = 0; // x offset position of the div label wrt 3D line.

  this.yDivOffset = 0; // y offset position of the div label wrt 3D line.    
...
markup3d.prototype.updateHitTest = function (event) {
  ...
  if (nodes.length > 0) {
    if (this.hovered) this.geometry.colors[this.hovered].r = 1.0;
...
markup3d.prototype.load = function () {
  ...
  this.offset = {
    ...
    y: 10,
    z: 0
  }; //overwritten offset to fit IPZ model

  console.log("OFFSET");
  console.log(this.offset); // setup listeners for new data and mouse events

  window.addEventListener("newData", function (e) {
    _this.setMarkupData(e.detail);
  }, false);
  ...
  document.addEventListener('touchend', function (e) {
    _this.onClickTouch(e);
  }, false);
  document.addEventListener('mousewheel', function (e) {
    _this.onMouseMove(e);
  }, true); // Load markup points into Point Cloud
  ...
  this.setMarkupData = function (data) {
    ...
    data.map(function (item) {
      ...
      _this2.geometry.vertices.push(point);

      _this2.geometry.colors.push(new THREE.Color(1.0, item.icon, 0)); // icon = 0..2 position in the horizontal icons.png sprite sheet
...
function navToggle() {
  ...
  toggleButton.onclick = function () {
    ...
    if (panel.classList.contains('nav-collapsed')) {
      ...
      panel.getElementsByClassName('p-2')[0].classList.add("d-none"); //  panel.getElementsByClassName("p-2 nav-active");
...
$(document).ready(function () {
  ...
  window.token = forgeDiv.dataset.token; //console.log(token);
  ...
  function onDocumentLoadSuccess(doc) {
    //console.log(doc);
    window.viewerDocument = doc; // A document contains references to 3D and 2D geometries.
    ...
    var initGeom = geometries[0]; // Create Viewer instance
    ...
    viewer = new Autodesk.Viewing.Private.GuiViewer3D(viewerDiv, config); // Load the chosen geometry
  ...
  function onLoadModelSuccess(model) {
    ...
    console.log('Validate model loaded: ' + (viewer.model === model)); //console.log("MODEL");
    //console.log(model);

    window.model = model;
    window.viewer = viewer; //console.log("SCENE");
  ...
  function getModifiedWorldBoundingBox(fragIds, fragList) {
    ...
    console.log(nodebBox); //detectors.push(nodebBox);
    //viewer.loadExtension("markup3d");
    //initializeMarkup(detectors);
...
__webpack_require__(/*! D:\_WEB Projects\Cockpit_Laravel\laravel\resources\js\Forge\Detectors.js */"./resources/js/Forge/Detectors.js");
__webpack_require__(/*! D:\_WEB Projects\Cockpit_Laravel\laravel\resources\js\Forge\Occupancy.js */"./resources/js/Forge/Occupancy.js");
module.exports = __webpack_require__(/*! D:\_WEB Projects\Cockpit_Laravel\laravel\resources\sass\app.scss */"./resources/sass/app.scss");
